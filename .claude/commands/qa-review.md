# Usage: /qa-review [files]
# Example: /qa-review inaudible_batch.py
...
Do not begin output until you have read all files. Report each file's lines after you have read it.
